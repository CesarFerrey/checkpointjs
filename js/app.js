...
//realice un if, para mostrar solo los paises de america del sur por que todos se sobrecargaba la pagina en el navegador
cardDom(country);
function ver() {}
function cardDom(data) {
  let main = "";
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    <div class="row g-0">
    <h4>${data[i].name.official}</h4>

      <div class="col-md-4">
        <div class="card-body">
            <h5 class="card-title">
            <img src="${data[i].flags.svg}" width="40"alt="">
            ${data[i].name.common}</h5>
            <p class="card-text">
  ...
  <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z"/>
            ...
            ${data[i].timezones}</p>
            <p class="card-text">   <a href=" ${data[i].maps.googleMaps}">
